...
# from dataset_step2 import FramesWavsDatasetMEL25VoxBoxQG2ImgPrompt as FramesWavsDatasetMEL25

from dataset.dataset_step2_continuous_5 import FramesWavsDatasetMEL25VoxBoxQG2ImgPrompt as FramesWavsDatasetMEL25
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="config/deepprompt_eam3d.yaml", help="path to config")
    parser.add_argument("--mode", default="train", choices=[
        "train","test"
    ])
    parser.add_argument("--gen", default="spade", choices=["original", "spade"])
    parser.add_argument("--log_dir", default='./output/bugs', help="path to log into")
...
#python -u prompt_st_dp_eam3d.py --config ./config/deepprompt_eam3d.yaml --device_ids 0 --checkpoint ckpt/qvt_img_pca_sync_4_01_11_304.pth.tar --log_dir outpuut/step2/exp3
#选择（-5，5）帧数,去掉重建任务，可视化后一帧
#飞书
